...
![Den 分组效果](screenshots/den-effect.png)

## 创建和分配 Den

![分配 Den](screenshots/den-assign.png)
...
![Open Den](screenshots/den-open.png)
...
![Restart Den](screenshots/den-restart.png)

点击 **Restart Den**，该 Den 下所有 Burrow 都会被重建，适合一次性刷新整个开发环境。

## Reorder Den

![Reorder Den](screenshots/den-reorder.png)
